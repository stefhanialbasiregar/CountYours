                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="payment_features_item text-center">
                            ...
                            <h4>Responsive</h4>
                            <p>Count Yours merupakan website yang bisa digunakan semua perangkat yang anda miliki, karena website ini sangat responsive.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="payment_features_item text-center">
        ...
        <section class="experts_team_area sec_pad">
            <div class="container">
                <div class="sec_title text-center mb_70">
                    ...
                    <p class="f_400 f_size_16">Website Count Yours ini dibangun dengan penuh cinta<br> Oleh kami para web developer Informatika Unsyiah</p>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-sm-6" style="margin-left: 300px;">
                        <div class="ex_team_item">
                            <img src="img/farrah.png" alt="">
                            <div class="team_content">
                                <a href="#">
                                    <h3 class="f_p f_size_16 f_600 t_color3">Farrah Fahira Murzani<i< /h3>
                                </a>
                                <h5>2008107010062</h5>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6" style="margin-top: 13px;">
                        <div class="ex_team_item">
                            <img src="img/stefhani.png" alt="">
                            <div class="team_content">
                                <a href="#">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="f_widget company_widget">
                                ...
                                <h6 style="color:white;">Copyright © 2022 CounYours.com</h6>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
...
</html><?php /**PATH C:\xampp\htdocs\CountYours\resources\views/aboutus.blade.php ENDPATH**/ ?>